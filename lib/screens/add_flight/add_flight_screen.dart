...
class _AddFlightScreenState extends State<AddFlightScreen>
  ...
  Widget _buildAirlineChip({required String label, required bool isSelected}) {
    ...
    return ChoiceChip(
      ...
      onSelected: (_) {
        setState(() {
          _selectedAirlineFilter = label == 'All' ? null : label;
          _selectedCatalogEntry = null;
          _errorMessage = null;
          _clearLookupResult();
        });
      ...
      labelStyle: TextStyle(
        color: isSelected ? scheme.onPrimary : themeColors.onCardMuted,
  ...
  Widget _buildCatalogEmptyState() {
    ...
    return Container(
      ...
      child: Column(
        children: [
          Icon(Icons.search_off, size: 34, color: themeColors.onCardMuted),
                  ...
                  children: [
                    ...
                    if (entry.isFeatured)
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: themeColors.successContainer,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              label,
              style: TextStyle(fontSize: 11, color: themeColors.onCardMuted),
            ),
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 13,
              color: themeColors.onSuccessContainer.withValues(alpha: 0.78),
            ),
          ),
        ],
      ),
